-- =====================================================================================
-- Migration 020: Database Schema Separation (KISS Principle Implementation)
-- =====================================================================================
-- 
...
-- =====================================================================================
-- STEP 2: Migrate Existing Technical Data to New Table
-- =====================================================================================
...
WHERE 
    ...
    OR sampling_rate IS NOT NULL
    OR array_length(channel_names, 1) > 0;
...
ALTER TABLE therapy_sessions DROP CONSTRAINT IF EXISTS therapy_sessions_sampling_rate_check;
ALTER TABLE therapy_sessions DROP CONSTRAINT IF EXISTS therapy_sessions_original_sampling_rate_check;

-- Drop technical columns (they now live in c3d_technical_data)
...
ALTER TABLE therapy_sessions DROP COLUMN IF EXISTS sampling_rate;
ALTER TABLE therapy_sessions DROP COLUMN IF EXISTS duration_seconds;
ALTER TABLE therapy_sessions DROP COLUMN IF EXISTS frame_count;
