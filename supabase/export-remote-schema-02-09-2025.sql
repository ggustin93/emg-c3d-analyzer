...
CREATE TABLE public.emg_statistics (
  ...
  mvc75_compliance_rate integer DEFAULT 0 CHECK (mvc75_compliance_rate >= 0),
  duration_compliance_rate integer DEFAULT 0 CHECK (duration_compliance_rate >= 0),
  ...
  mvc75_threshold double precision,
...
CREATE TABLE public.patients (
  ...
  current_duration_ch1_seconds double precision CHECK (current_duration_ch1_seconds > 0::double precision),
  current_duration_ch2_seconds double precision CHECK (current_duration_ch2_seconds > 0::double precision),
