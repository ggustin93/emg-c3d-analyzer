...
class TestCompleteWorkflow:
    ...
    def sample_c3d_file(self):
        ...
        if sample_path.exists():
            ...
            if relative_path.exists():
                ...
                print(f"⚠️ Real C3D file not found, creating mock file for testing")
                if np is None:
    ...
    def test_complete_emg_analysis_workflow(self, sample_c3d_file):
        ...
        print(f"🎉 Complete E2E Workflow Test Passed!")
        ...
        while time.time() - start_time < timeout:
            ...
            if status_response.status_code == 200:
                ...
                if signals_response.status_code == 200:
                    print(f"✅ Processing completed (signals available)")
                    return
    ...
    def _test_data_export(self, session_id: str):
        ...
        if export_response.status_code == 200:
            ...
            print(f"⚠️ Export endpoint not available")
        else:
    ...
    def _test_manual_processing_workflow(self, sample_c3d_file: Path):
        ...
        print(f"🔧 Testing manual processing workflow")
        ...
        try:
            ...
            print(f"⚠️ Manual processing failed: {str(e)}")
            print(f"   This may be expected for mock data")
...
async def test_webhook_e2e_processing():
    ...
    if webhook_response.status_code == 200:
        ...
        print(f"⚠️ Webhook returned 404 - file not found in storage (expected for test)")
