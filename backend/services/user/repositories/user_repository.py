...
class UserRepository(AbstractRepository[UserProfileCreate, UserProfileUpdate, UserProfile]):
    ...
    def get_user_profile(self, user_id: str | UUID) -> dict[str, Any] | None:
        ...
        try:
            ...
            self.logger.error(f"Failed to get user profile {user_id}: {e!s}")
    ...
    def get_users_by_role(
        ...
        try:
            ...
            self.logger.error(f"Failed to get users by role {role}: {e!s}")
    ...
    def get_users_by_institution(
        ...
        try:
            ...
            return self._handle_supabase_response(result, "get", f"users by institution {institution}")

        except Exception as e:
            self.logger.error(f"Failed to get users by institution {institution}: {e!s}")
    ...
    def update_last_login(self, user_id: str | UUID) -> None:
        ...
        try:
            ...
            self.logger.warning(f"Failed to update last login for user {user_id}: {e!s}")
