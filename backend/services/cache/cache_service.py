...
class CacheService:
    ...
    async def cache_analysis_results(
        ...
        try:
            ...
            logger.error(f"Failed to cache analysis results: {e!s}")
            raise
    ...
    async def get_cached_analysis(
        ...
        try:
            ...
            logger.error(f"Failed to retrieve cached analysis: {e!s}")
            return None
    ...
    async def cleanup_expired_cache(self) -> int:
        ...
        try:
            ...
            logger.error(f"Failed to cleanup expired cache: {e!s}")
            return 0
